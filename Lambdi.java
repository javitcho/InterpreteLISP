...
/**
 * Esta clase realiza el cálculo lambda de las S expresiones, llamada Lambdi la calculadora lambda. (Y la tokenizadora)
 * Los métodos de esta clase son estáticos para nunca instanciarla, y así evitar problemas al tokenizar la entrada.
 * @author javi-
 */
public class Lambdi {
    ...
    /**
     * Esta es la función tokenizadora toma un inputstream y devuelve la expresión S correspondiente.
