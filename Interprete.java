...
public class Interprete {
    ...
    public SExp APPLY(SExp f, SExp x, ListaAsociacion aList, ListaDefinicion dList) throws Exception
    {
        ...
        if (fName.equalsIgnoreCase("PLUS")| fName.equalsIgnoreCase("+"))
        {
            ...
            return Lambdi.PLUS(x.CAR(), x.CDR().CAR());
        }
        ...
        if (fName.equalsIgnoreCase("TIMES")| fName.equalsIgnoreCase("*"))
        {
            ...
            return Lambdi.TIMES(x.CAR(), x.CDR().CAR());
        }
     ...
     * @throws java.lang.Exception
     */
    public void CheckParamCount(String funcName, SExp paramList, int num) throws Exception
    {
     ...
     * @throws java.lang.Exception
     */
    public void ConditionalValidation(SExp condExp) throws Exception
    {
     ...
     * @throws java.lang.Exception
     */
    public void DefunValidation(SExp def) throws Exception
    {
        if (def.Length() != 4)
        {
